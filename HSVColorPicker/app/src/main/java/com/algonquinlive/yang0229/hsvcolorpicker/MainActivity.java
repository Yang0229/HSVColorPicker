package com.algonquinlive.yang0229.hsvcolorpicker;

/**
 *  App Name: HSV color picker
 *
 *  Description: This is a color picker Application for android devices.
 *               Users can create their own color by using 3 seekBar:
 *               1. Hue
 *               2. Saturation
 *               3. Value/ Brightness
 *               Moreover, there are some demo color button below the seekBar, that will show the
 *               numerical values of Hue, Saturation and Value/ Brightness.
 *
 *  @author Bo Yang (yang0229)
 *
 *  Tinker
 *  Version 1.0
 */
...
public class MainActivity extends Activity implements Observer, SeekBar.OnSeekBarChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mHueTV = (TextView) findViewById(R.id.hueText);
        mSaturationTV = (TextView) findViewById(R.id.saturationText);
        mValueTV = (TextView) findViewById(R.id.valueText);
